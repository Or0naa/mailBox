    ...
    <div>
      <ul className="list-none">
        {contacts.map((contact, index) => (
          <li key={index} className={`flex items-center justify-between border-b border-gray-300 py-2 hover:shadow-2xl transition duration-300 ${selectedContact === index ? 'bg-white' : 'bg-slate-100'}`} onClick={() => handleContactClick(index)}>
            <img
            ...
            <div className="flex items-center">
              <div>
                ...
                <p className="text-gray-600">Lorem ipsum dolor sit amet because...</p>
              </div>
            </div>
